...
class _PlaceOrderState extends State<PlaceOrder> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) {
      Provider.of<LabTestProvider>(context, listen: false).initValues();
    });
  }
              ...
              builder: (context, model, child) =>
                  Center(
                      child: CommonWidgets().roundButton(
                        ...
                        model.placeOrder(failure: (message) {
                          CommonWidgets.showToast(
                              context, message, _scaffoldKey);
                        }, success: (isNotEmpty, message) {
                          if (isNotEmpty) {
                            CommonWidgets().showOkPopup(
                                context, Strings.orderplacedSuccessHeader,
                                message,
                                onTapp: () {
                            ...
                            Column(
                              ...
                              children: [
                                ...
                                CommonWidgets().customFormFieldController(
                                    context,
                                    Strings.units,
                                    TextInputAction.done, onChanged: (text) {
                                  model.pharmacy_order_item.prescribed_drugs
                                      .elementAt(index)
                                      .unit = int.parse(text.toString().trim());
                                },
                                    maxLenghth: 3,
        ...
        builder: (context, model, child) =>
            Column(
              ...
              children: [
                                ...
                                PopupMenuButton(
                                    ...
                                    onSelected: (item) {
                                      ...
                                      model.lab_order_item.laboratory =
                                          item.requisition_name;
                                      model.lab_order_item.requisition_id =
                                          item.id;
                ...
                //                 value: model.isBloodSugar,
                //                 onChanged: (isCheck) {
                //                   model.setBloodSugar(isCheck);
                //                 })),
                //       ),
                //     ],
                //   ),
                ...
                //         child: Consumer<PlaceOrderProvider>(
                //             builder: (context, model, child) => Switch(
                //                 value: model.isCholesterol,
                //                 onChanged: (isCheck) {
                //                   model.setCholesterol(isCheck);
                //                 })),
                //       ),
                //     ],
                //   ),
