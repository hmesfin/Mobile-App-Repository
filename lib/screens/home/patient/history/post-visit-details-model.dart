...
//
//     final postVisitDetailsModel = postVisitDetailsModelFromJson(jsonString);

import 'dart:convert';

class PostVisitDetailsModel {
  ...
  factory PostVisitDetailsModel.fromRawJson(String str) =>
      PostVisitDetailsModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory PostVisitDetailsModel.fromJson(Map<String, dynamic> json) =>
      PostVisitDetailsModel(
        ...
        doctorsNoteProgressNote: json["doctors_note_progress_note"] != null
            ? DoctorsNoteProgressNote.fromJson(
            json["doctors_note_progress_note"])
            : null,
...
class DoctorsNoteProgressNote {
  ...
  factory DoctorsNoteProgressNote.fromRawJson(String str) =>
      DoctorsNoteProgressNote.fromJson(json.decode(str));
  ...
  factory DoctorsNoteProgressNote.fromJson(Map<String, dynamic> json) =>
      DoctorsNoteProgressNote(
        ...
        neuro: json["neuro"] ?? '',
        psych: json["psych"] ?? '',
        entMouth: json["ENT_mouth"] ?? '',
        endocrine: json["endocrine"] ?? '',
        hemeLymph: json["heme_lymph"] ?? '',
  ...
  Map<String, dynamic> toJson() =>
      {
        ...
        "ENT_mouth": entMouth,
        "endocrine": endocrine,
        "heme_lymph": hemeLymph,
        "respiratory": respiratory,
        "genitourinary": genitourinary,
        "cardiovascular": cardiovascular,
        "constitutional": constitutional,
        "mosculoskeletan": mosculoskeletan,
